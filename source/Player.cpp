...
void Player::playerPhysics() {
	if(!Application::getMap()->getUnderWater()) {
		if (jumpState == 1) {
			...
			if(onPlatformID == -1) {
				onPlatformID = Application::getMap()->checkCollisionWithPlatform((int)fXPos, (int)fYPos, getHitBoxX(), getHitBoxY());
				if(onPlatformID >= 0) {
					if (Application::getMap()->checkCollisionLB((int)(fXPos - Application::getMap()->getXPos() + 2), (int)fYPos + 2, getHitBoxY(), true) || Application::getMap()->checkCollisionRB((int)(fXPos - Application::getMap()->getXPos() - 2), (int)fYPos + 2, getHitBoxX(), getHitBoxY(), true)) {
						onPlatformID = -1;
						resetJump();
					} else {
						fYPos = (float)Application::getMap()->getPlatform(onPlatformID)->getYPos() - getHitBoxY();
						resetJump();
						Application::getMap()->getPlatform(onPlatformID)->turnON();
					}
				}
			} else {
				onPlatformID = Application::getMap()->checkCollisionWithPlatform((int)fXPos, (int)fYPos, getHitBoxX(), getHitBoxY());
			...
			if(onPlatformID >= 0) {
				if (Application::getMap()->checkCollisionLB((int)(fXPos - Application::getMap()->getXPos() + 2), (int)fYPos + 2, getHitBoxY(), true) || Application::getMap()->checkCollisionRB((int)(fXPos - Application::getMap()->getXPos() - 2), (int)fYPos + 2, getHitBoxX(), getHitBoxY(), true)) {
					...
					fYPos += Application::getMap()->getPlatform(onPlatformID)->getMoveY();
					Application::getMap()->getPlatform(onPlatformID)->moveY();
					//if(moveSpeed == 0)
					Application::getMap()->setXPos(Application::getMap()->getXPos() - Application::getMap()->getPlatform(onPlatformID)->getMoveX());
			
					jumpState = 0;
				}
			}
			else if (!Application::getMap()->checkCollisionLB((int)(fXPos - Application::getMap()->getXPos() + 2), (int)fYPos + 2, getHitBoxY(), true) &&
				!Application::getMap()->checkCollisionRB((int)(fXPos - Application::getMap()->getXPos() - 2), (int)fYPos + 2, getHitBoxX(), getHitBoxY(), true)) {
		...
		if(nextBubbleTime + 685 < SDL_GetTicks()) {
			Application::getMap()->addBubble((int)(fXPos - Application::getMap()->getXPos() + (moveDirection ? getHitBoxX() - rand()%8 : rand()%8)), (int)fYPos + 4);
		...
		if (jumpState == 1) {
			...
			if (!Application::getMap()->checkCollisionLB((int)(fXPos - Application::getMap()->getXPos() + 2), (int)fYPos + 2, getHitBoxY(), true) &&
				!Application::getMap()->checkCollisionRB((int)(fXPos - Application::getMap()->getXPos() - 2), (int)fYPos + 2, getHitBoxX(), getHitBoxY(), true)) {
...
void Player::movePlayer() {
	if (bMove && !changeMoveDirection && (!bSquat || powerLVL == 0)) {
		...
		if (SDL_GetTicks() - (50 + 15 * (currentMaxMove - moveSpeed) * (bSquat && powerLVL > 0 ? 6 : 1)) > iTimePassed && moveSpeed != 0) {
			--moveSpeed;
			iTimePassed = SDL_GetTicks();
			if (jumpState == 0 && !Application::getMap()->getUnderWater()) setMarioSpriteID(6);
		}
	...
	if(bSquat && !Application::getMap()->getUnderWater() && powerLVL > 0) {
		setMarioSpriteID(7);
	}
}
...
void Player::startRun() {
	currentMaxMove = maxMove + (Application::getMap()->getUnderWater() ? 0 : 2);
...
void Player::createFireBall() {
	if(powerLVL == 2) {
		if(nextFireBallFrameID <= 0) {
			Application::getMap()->addPlayerFireBall((int)(fXPos - Application::getMap()->getXPos() + (moveDirection ? getHitBoxX() : -32)), (int)(fYPos + getHitBoxY()/2), !moveDirection);
...
void Player::updateXPos(int iN) {
	...
	if (iN > 0) {
		if (!Application::getMap()->checkCollisionRB((int)(fXPos - Application::getMap()->getXPos() + iN), (int)fYPos - 2, getHitBoxX(), getHitBoxY(), true) && !Application::getMap()->checkCollisionRT((int)(fXPos - Application::getMap()->getXPos() + iN), (int)fYPos + 2, getHitBoxX(), true) &&
			(powerLVL == 0 ? true : (!Application::getMap()->checkCollisionRC((int)(fXPos - Application::getMap()->getXPos() + iN), (int)fYPos, getHitBoxX(), getHitBoxY() / 2, true))))
		{
			if (fXPos >= 416 && Application::getMap()->getMoveMap()) {
				Application::getMap()->moveMap(-iN, 0);
			}
			else {
				fXPos += iN;
			}
		...
		if (!Application::getMap()->checkCollisionLB((int)(fXPos - Application::getMap()->getXPos() + iN), (int)fYPos - 2, getHitBoxY(), true) && !Application::getMap()->checkCollisionLT((int)(fXPos - Application::getMap()->getXPos() + iN), (int)fYPos + 2, true) &&
				(powerLVL == 0 ? true : (!Application::getMap()->checkCollisionLC((int)(fXPos - Application::getMap()->getXPos() + iN), (int)fYPos, getHitBoxY() / 2, true))))
			{
			if (fXPos <= 192 && Application::getMap()->getXPos() && Application::getMap()->getMoveMap() && CCFG::canMoveBackward) {

				Application::getMap()->moveMap(-iN, 0);
			}
			else if(fXPos - Application::getMap()->getXPos() + iN >= 0 && fXPos >= 0) {
				fXPos += iN;
...
void Player::updateYPos(int iN) {
	...
	if (iN > 0) {
		bLEFT  = Application::getMap()->checkCollisionLB((int)(fXPos - Application::getMap()->getXPos() + 2), (int)fYPos + iN, getHitBoxY(), true);
		bRIGHT = Application::getMap()->checkCollisionRB((int)(fXPos - Application::getMap()->getXPos() - 2), (int)fYPos + iN, getHitBoxX(), getHitBoxY(), true);
		...
		bLEFT  = Application::getMap()->checkCollisionLT((int)(fXPos - Application::getMap()->getXPos() + 2), (int)fYPos + iN, false);
		bRIGHT = Application::getMap()->checkCollisionRT((int)(fXPos - Application::getMap()->getXPos() - 2), (int)fYPos + iN, getHitBoxX(), false);

		if(Application::getMap()->checkCollisionWithPlatform((int)fXPos, (int)fYPos, 0, 0) >= 0 || Application::getMap()->checkCollisionWithPlatform((int)fXPos, (int)fYPos, getHitBoxX(), 0) >= 0) {
			jumpState = 2;
		}
			...
			if (jumpState == 1) {
				if (!bLEFT && bRIGHT) {
					Vector2* vRT = getBlockRT(fXPos - Application::getMap()->getXPos(), fYPos + iN);

					if(!Application::getMap()->getBlock(Application::getMap()->getMapBlock(vRT->getX(), vRT->getY())->getBlockID())->getVisible()) {
						if(Application::getMap()->blockUse(vRT->getX(), vRT->getY(), Application::getMap()->getMapBlock(vRT->getX(), vRT->getY())->getBlockID(), 0)) {
							jumpState = 2;
						} else {
							fYPos += iN;
						}
					} else if((int)(fXPos + getHitBoxX() - Application::getMap()->getXPos()) % 32 <= 8) {
						updateXPos((int)-((int)(fXPos + getHitBoxX() - Application::getMap()->getXPos()) % 32));
					} else if(Application::getMap()->getBlock(Application::getMap()->getMapBlock(vRT->getX(), vRT->getY())->getBlockID())->getUse()) {
						if(Application::getMap()->blockUse(vRT->getX(), vRT->getY(), Application::getMap()->getMapBlock(vRT->getX(), vRT->getY())->getBlockID(), 0)) {
							jumpState = 2;
						} else {
							fYPos += iN;
					...
					Vector2* vLT = getBlockLT(fXPos - Application::getMap()->getXPos(), fYPos + iN);
					if(!Application::getMap()->getBlock(Application::getMap()->getMapBlock(vLT->getX(), vLT->getY())->getBlockID())->getVisible()) {
						if(Application::getMap()->blockUse(vLT->getX(), vLT->getY(), Application::getMap()->getMapBlock(vLT->getX(), vLT->getY())->getBlockID(), 0)) {
							jumpState = 2;
						} else {
							fYPos += iN;
						}
					} else if ((int)(fXPos - Application::getMap()->getXPos()) % 32 >= 24) {
						updateXPos((int)(32 - (int)(fXPos - Application::getMap()->getXPos()) % 32));
					} else if(Application::getMap()->getBlock(Application::getMap()->getMapBlock(vLT->getX(), vLT->getY())->getBlockID())->getUse()) {
						if(Application::getMap()->blockUse(vLT->getX(), vLT->getY(), Application::getMap()->getMapBlock(vLT->getX(), vLT->getY())->getBlockID(), 0)) {
							jumpState = 2;
						} else {
							fYPos += iN;
					...
					if ((int)(fXPos + getHitBoxX() - Application::getMap()->getXPos()) % 32 > 32 - (int)(fXPos - Application::getMap()->getXPos()) % 32) {
						Vector2* vRT = getBlockRT(fXPos - Application::getMap()->getXPos(), fYPos + iN);

						if (Application::getMap()->getBlock(Application::getMap()->getMapBlock(vRT->getX(), vRT->getY())->getBlockID())->getUse()) {
							if(Application::getMap()->blockUse(vRT->getX(), vRT->getY(), Application::getMap()->getMapBlock(vRT->getX(), vRT->getY())->getBlockID(), 0)) {
								jumpState = 2;
							}
						} else {
						...
						if (Application::getMap()->getBlock(Application::getMap()->getMapBlock(vLT->getX(), vLT->getY())->getBlockID())->getUse()) {
							if(Application::getMap()->blockUse(vLT->getX(), vLT->getY(), Application::getMap()->getMapBlock(vLT->getX(), vLT->getY())->getBlockID(), 0)) {
								jumpState = 2;
							}
						} else {
	...
	if(!Application::getMap()->getInEvent() && fYPos - getHitBoxY() > CCFG::GAME_HEIGHT) {
		Application::getMap()->playerDeath(false, true);
		fYPos = -80;
	}
}
...
bool Player::checkCollisionBot(int nX, int nY) {
	Vector2* vLT = getBlockLB(fXPos - Application::getMap()->getXPos() + nX, fYPos + nY);

	if (Application::getMap()->getBlock(Application::getMap()->getMapBlock(vLT->getX(), vLT->getY())->getBlockID())->getUse()) {
		Application::getMap()->blockUse(vLT->getX(), vLT->getY(), Application::getMap()->getMapBlock(vLT->getX(), vLT->getY())->getBlockID(), 1);
	}

	delete vLT;

	vLT = getBlockRB(fXPos - Application::getMap()->getXPos() + nX, fYPos + nY);
...
bool Player::checkCollisionCenter(int nX, int nY) {
	if(powerLVL == 0) {
		Vector2* vLT = getBlockLC(fXPos - Application::getMap()->getXPos() + nX, fYPos + nY);

		if (Application::getMap()->getBlock(Application::getMap()->getMapBlock(vLT->getX(), vLT->getY())->getBlockID())->getUse()) {
			Application::getMap()->blockUse(vLT->getX(), vLT->getY(), Application::getMap()->getMapBlock(vLT->getX(), vLT->getY())->getBlockID(), 2);
		}

		delete vLT;

		vLT = getBlockRC(fXPos - Application::getMap()->getXPos() + nX, fYPos + nY);
		...
		Vector2* vLT = getBlockLC(fXPos - Application::getMap()->getXPos() + nX, fYPos + nY + (powerLVL > 0 ? 16 : 0));
		...
		vLT = getBlockRC(fXPos - Application::getMap()->getXPos() + nX, fYPos + nY + (powerLVL > 0 ? 16 : 0));
		...
		vLT = getBlockLC(fXPos - Application::getMap()->getXPos() + nX, fYPos + nY - (powerLVL > 0 ? 16 : 0));
...
Vector2* Player::getBlockLB(float nX, float nY) {
	return Application::getMap()->getBlockID((int)nX + 1, (int)nY + getHitBoxY() + 2);
}

Vector2* Player::getBlockRB(float nX, float nY) {
	return Application::getMap()->getBlockID((int)nX + getHitBoxX() - 1, (int)nY + getHitBoxY() + 2);
}
...
Vector2* Player::getBlockLT(float nX, float nY) {
	return Application::getMap()->getBlockID((int)nX + 1, (int)nY);
}

Vector2* Player::getBlockRT(float nX, float nY) {
	return Application::getMap()->getBlockID((int)nX + getHitBoxX() - 1, (int)nY);
}

/* ******************************************** */

void Player::Draw(SDL_Renderer* rR) {
	if(!inLevelDownAnimation || Application::getMap()->getInEvent()) {
		sMario[getMarioSpriteID()]->getTexture()->Draw(rR, (int)fXPos, (int)fYPos + (Application::getMap()->getInEvent() ? 0 : 2), !moveDirection);
	} else {
...
void Player::setPowerLVL(int powerLVL) {
	if(powerLVL <= 2) {
		if(this->powerLVL < powerLVL) {
			...
			Application::getMap()->addPoints((int)(fXPos - Application::getMap()->getXPos() + getHitBoxX() / 2), (int)fYPos + 16, "1000", 8, 16);
		...
		++iNumOfLives;
		Application::getMap()->addPoints((int)(fXPos - Application::getMap()->getXPos() + getHitBoxX() / 2), (int)fYPos + 16, "1UP", 10, 14);
...
void Player::setSquat(bool bSquat) {
	if(bSquat && this->bSquat != bSquat) {
		...
		this->bSquat = bSquat;
	} else if(this->bSquat != bSquat && !Application::getMap()->getUnderWater()) {
		if(powerLVL > 0) {
			fYPos -= 20;
		}
		this->bSquat = bSquat;
